...
### Task 4: Delete Unused LocalizedInputGrid Component

**Files:**
- Delete: `frontend/src/components/forms/LocalizedInputGrid.tsx`

- [ ] **Step 1: ลบไฟล์ LocalizedInputGrid.tsx**
  ลบไฟล์ออกจากระบบเนื่องจากไม่พบการเรียกใช้งาน
  Run: `rm frontend/src/components/forms/LocalizedInputGrid.tsx`
- [ ] **Step 2: Commit**
  ```bash
  git rm frontend/src/components/forms/LocalizedInputGrid.tsx
  git commit -m "feat: delete unused LocalizedInputGrid component"
  ```
