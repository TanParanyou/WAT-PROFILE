...
type Monk struct {
	...
	DharmaName     MultiLangText     `gorm:"type:jsonb" json:"dharma_name"` // ฉายาทางธรรม เช่น "ญาณสํวโร"
	Education      MultiLangText     `gorm:"type:jsonb" json:"education"`   // วิทยฐานะ/วุฒิการศึกษาทางธรรม
	Bio            LocalizedRichText `gorm:"type:jsonb" json:"bio"`         // ประวัติ
	OrdinationDate DateOnly          `gorm:"type:date" json:"ordination_date"`
