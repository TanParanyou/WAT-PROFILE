...
func adminRouteDefinitions() []AdminRouteDefinition {
	return []AdminRouteDefinition{
		...
		{Method: fiber.MethodGet, Path: "/donations/annual-summary", Resource: "donations", Action: "read", HandlerKey: "donations.annualSummary"},
		{Method: fiber.MethodGet, Path: "/donations/annual-statement", Resource: "donations", Action: "read", HandlerKey: "donations.annualStatement"},
		...
		{Method: fiber.MethodGet, Path: "/donations/:id/receipt", Resource: "donations", Action: "read", HandlerKey: "donations.receipt"},
		...
		{Method: fiber.MethodPost, Path: "/event-registrations", Resource: "events", Action: "create", HandlerKey: "registrations.adminCreate"},
		...
		{Method: fiber.MethodPost, Path: "/event-registrations/check-in", Resource: "events", Action: "update", HandlerKey: "registrations.checkIn"},
...
func adminHandlerMap(db *gorm.DB, r2 *storage.R2Service, accountCfg config.AccountAuthConfig) map[string]fiber.Handler {
	...
	return map[string]fiber.Handler{
		...
		"donations.annualSummary":       donationHandler.GetAnnualSummary,
		"donations.annualStatement":     donationHandler.GetDonorAnnualStatement,
		...
		"donations.receipt":             donationHandler.GetDonationReceipt,
		...
		"registrations.adminCreate":     registrationHandler.CreateAdminRegistration,
		...
		"registrations.checkIn":         registrationHandler.CheckInByCode,
