  ...
  return (
    <div className="relative flex items-center flex-1 min-w-[200px] max-w-md">
      ...
      <input
        ...
        aria-label={t("search")}
        className="w-full h-11 pl-9 pr-20 text-sm border border-gray-300 rounded-lg bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-colors"
      />
