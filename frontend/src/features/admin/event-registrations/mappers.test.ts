...
test("maps typed registration item to admin table row", () => {
  ...
  assert.deepEqual(row, { id: 7, name: "Ada Lovelace", email: "ada@example.com", phone: "123", event_title: "Vesak", status: "pending", created_at: "2026-01-01T00:00:00Z", participant_count: 2 });
});
