...
export function DonationForm() {
  ...
  return <form onSubmit={submit} className="mt-8 grid gap-4 border border-site-border bg-site-canvas p-6 md:grid-cols-2">
    ...
    <label className="grid gap-2 text-sm"><span>{t("currencyLabel")}</span><select name="currency" defaultValue="EUR" className="min-h-11 border border-site-border bg-white px-3"><option value="EUR">EUR</option></select></label>
