    ...
    <div className="min-h-screen bg-background">
      ...
      <PageContainer width="content">
        ...
        <section className="mt-20 border-t border-site-border pt-16" aria-labelledby="events-heading">
          <PublicSectionHeading id="events-heading" title={tPage("upcomingEvents")} description={tPage("subtitle")} action={<Link href="/calendar" className="inline-flex min-h-11 items-center border border-site-border px-4 text-sm text-site-foreground hover:bg-site-surface focus-visible:outline-2 focus-visible:outline-site-focus">{tPage("calendarView")}</Link>} />
          <div className="mt-8">
