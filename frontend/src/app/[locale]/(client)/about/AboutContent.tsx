...
export default function AboutContent() {
  ...
  const navItems = [
    ...
    {
      id: "objective",
      label: getLocalizedText(aboutData.objective.navTitle, locale),
    },
    {
      id: "administration",
      label: getLocalizedText(aboutData.administration.navTitle, locale),
    },
    {
      id: "history",
      label: getLocalizedText(aboutData.buddhaHistory.navTitle, locale),
    },
    {
      id: "buildings",
      label: getLocalizedText(aboutData.buildings.title, locale),
    },
    {
      id: "sangha",
      label: getLocalizedText(aboutData.sangha.navTitle, locale),
    },
  ];
              ...
              <div className="bg-white dark:bg-zinc-900 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-800 p-8 md:p-10 hover:shadow-md transition-shadow">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 not-prose mt-12 pt-12 border-t border-gray-100 dark:border-gray-800">
                  {activeMonks.map((monk) => (
                    <div
                      key={monk.id}
                      className="group bg-zinc-50 dark:bg-zinc-800/50 rounded-2xl overflow-hidden border border-gray-100 dark:border-gray-800 hover:shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:hover:shadow-black/20 transition-all duration-300 hover:-translate-y-1"
                    >
