            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-zinc-950 focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-all"
                  />
                </div>
                <div className="space-y-2">
                  <label
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  className="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-zinc-950 focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-all resize-none"
                />
              </div>
              ...
              <button
                ...
                className={`w-full font-bold py-4 rounded-xl transition-all flex items-center justify-center gap-2 transform active:scale-95 ${status === "success" ? "bg-green-600 text-white" : status === "error" ? "bg-red-600 text-white" : "bg-primary text-white hover:bg-primary/90 shadow-lg hover:shadow-primary/30"}`}
              >
                {status === "loading" ? (
                ...
                <div className="w-full md:w-2/5">
                  <div className="bg-gray-50 dark:bg-zinc-800/30 p-1 rounded-3xl border border-gray-100 dark:border-gray-800/50 h-full">
                    <div className="bg-white dark:bg-zinc-900/50 rounded-[20px] p-8 h-full flex flex-col">
                      ...
                      <p className="text-gray-600 dark:text-gray-400 mb-8 leading-relaxed text-base grow">
                        {getLocalizedText(
                          contactData.transport.car.text,
                          locale,
                        )}
                      </p>

                      <a
                        href={contactData.transport.directionsUrl}
                        target="_blank"
                        className="w-full inline-flex items-center justify-center gap-2 bg-slate-900 dark:bg-white text-white dark:text-slate-900 px-6 py-4 rounded-xl font-bold hover:bg-slate-800 dark:hover:bg-gray-100 transition-colors"
                      >
              ...
              <div className="bg-white dark:bg-zinc-900 p-8 rounded-3xl border border-gray-100 dark:border-gray-800 shadow-sm hover:shadow-md transition-all text-center group flex-1 flex flex-col items-center justify-center">
                ...
                <div className="space-y-1">
                  <p className="text-gray-500 dark:text-gray-400 font-medium text-sm uppercase tracking-wide">
                    {getLocalizedText(contactData.openingHours.days, locale)}
                  </p>
                  <p className="text-3xl font-heading font-bold text-primary">
                    {contactData.openingHours.time}
                  </p>
                  <p className="text-sm text-gray-400 dark:text-gray-500 mt-2 italic">
                    {getLocalizedText(contactData.openingHours.remark, locale)}
                  </p>
                </div>
              </div>
